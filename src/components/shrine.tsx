...
const Section = ({
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-6 space-x-3 xl:space-x-4 w-fit mx-auto">
      ...
      <div className="text-center spacing-y-2 mt-8">
        ...
        <div className="flex justify-center">
          <div className="w-[3.75rem] h-[3.75rem] text-center align-middle bg-[url('public/assets/battlecard/orb.png')] bg-contain bg-center bg-no-repeat flex items-center justify-center">
...
const Shrine = () => {
  ...
  return (
    <div className="w-full sm:bg-[url('public/assets/shrine/background.png')] bg-left bg-cover bg-no-repeat">
      <div className="gradient-two xl:pb-32">
        ...
        <div className="w-full bg-[url('public/assets/shrine/background.png')] sm:bg-none bg-center bg-cover bg-no-repeat sm:pl-10">
          <div className="grid sm:grid-cols-2 xl:grid-cols-3 gradient-two sm:bg-none sm:items-center">
            <div className="w-full px-8 sm:pl-8 sm:pr-4 mt-2 sm:mt-20">
              <span className="hidden sm:block heading-lg md:heading-2lg lg:heading-3lg xl:heading-2xl font-bold text-primary-90 mt-10">
                {Object.values(types)[
                  shrineIndexes[selectedShrineTypeIndex]
                ].plural.toUpperCase()}
              </span>
              ...
              <div className="flex items-center mt-5 space-x-2">
                <img
                  ...
                  alt="card_1"
                  className="w-10 h-10 sm:w-12 sm:h-12 lg:h-[3.8rem] lg:w-[4rem] xl:h-[4.6rem] xl:w-[4.8rem] shrine_card_border_selected"
                />
                <img
                  src={
                    assets[
                  ...
                  alt="card_2"
                  className="w-10 h-10 sm:w-12 sm:h-12 lg:h-[3.8rem] lg:w-[4rem] xl:h-[4.6rem] xl:w-[4.8rem] shrine_card_border"
                />
              </div>
            ...
            <div className="relative mt-12 md:-mt-12">
              ...
              <img
                src={
                  assets[
                    shrineTypes[selectedShrineTypeIndex] as keyof typeof assets
                  ].nft
                }
                alt="hades"
          ...
          <div className=" w-full h-16 gradient-three" />
        </div>
      </div>
