  ...
  return (
    <div className='sm:flex w-full lg:flex-col lg:gap-y-8 lg:mx-auto justify-center items-center'>
      <div className='grid grid-cols-3 gap-2 w-fit mx-auto sm:mx-[0px] sm:mr-8'>
        <ImageWithFallback src='forge/kostas' alt='kostas_card_one' className='w-[6.25rem] h-[8.125rem] lg:w-[8.5rem] lg:h-[11.12rem] xl:w-[9.5rem] xl:h-[12.12rem]' />
        <ImageWithFallback src='forge/kostas' alt='kostas_card_two' className='w-[6.25rem] h-[8.125rem] lg:w-[8.5rem] lg:h-[11.12rem] xl:w-[9.5rem] xl:h-[12.12rem]' />
        <ImageWithFallback src='forge/kostas' alt='kostas_card_three' className='w-[6.25rem] h-[8.125rem] lg:w-[8.5rem] lg:h-[11.12rem] xl:w-[9.5rem] xl:h-[12.12rem]' />
      </div>
      <div className='w-full sm:w-fit flex items-center justify-center sm:justify-start mt-16 sm:mt-[0px]'>
        <div className='flex flex-col w-fit items-center mr-8'>
          <ImageWithFallback src={'forge/fusion'} alt='fusion_symbol' className='w-[3.75rem] h-[3.75rem] lg:w-[6rem] lg:h-[6rem] xl:w-[7rem] xl:h-[7rem]' />
          <span className='text-primary-85 font-bold heading-sm mt-1'>Fusion</span>
        </div>
        <ImageWithFallback src='forge/kostas_forged' alt='kostas_card' className='evolved_red w-[6.25rem] h-[8.125rem] lg:w-[8.5rem] lg:h-[11.12rem] xl:w-[9.5rem] xl:h-[12.12rem]' />
      </div>
    </div>
  );
};
      ...
      <div style={{backgroundImage: `url(${getImageUrl("forge/background")}.${imageType})`}} className="bg-cover bg-center bg-no-repeat">
        <div className="sm:grid sm:grid-cols-2 sm:pl-12 md:pl-10 sm:gradient-two">
          <div className='sm:pt-20 md:pl-10 sm:mt-6'>
            ...
            <h2 className='text-primary-85 font-medium text-center sm:text-left heading-xs lg:heading-lg xl:heading-2lg mt-8 sm:mt-12 px-8 sm:px-[0px] sm:max-w-xs lg:max-w-2xl'>Ignite the Flames and let Hephaestus Start <span className='text-red-50'>Forging!</span></h2>
          </div>
          <div className='hidden sm:block sm:relative'>
            ...
            <ImageWithFallback src='forge/nft' alt='hades' className='w-[13.75rem] h-[17.62rem] sm:w-[15rem] sm:h-[19.5rem] lg:w-[17rem] lg:h-[21.5rem] xl:w-[23.75rem] xl:h-[30.62rem]  mx-auto translate-y-24 relative' />
          </div>
        </div>
        <div className="sm:bg-none bg-cover bg-center bg-no-repeat">
          <div className='gradient-two sm:hidden'>
            <div className='relative'>
              ...
              <ImageWithFallback src='forge/nft' alt='hades' className='w-[13.75rem] h-[17.62rem] mx-auto translate-y-24 relative' />
            </div>
          </div>
        ...
        <div className='mt-12 sm:mt-24 px-8  sm:text-center lg:max-w-full lg:text-left lg:grid lg:grid-cols-2 items-center'>
          ...
          <div className='sm:flex justify-center items-center sm:mt-12 lg:col-span-1'>
            <div className='grid grid-cols-2 w-fit mx-auto sm:mx-[0px] sm:mr-8 justify-center space-x-2 mt-12 sm:mt-[0px]'>
              <ImageWithFallback src='forge/hector' alt='hector_card' className='w-[6.25rem] h-[8.125rem] lg:w-[8.5rem] lg:h-[11.12rem] xl:w-[9.5rem] xl:h-[12.12rem]' />
              <ImageWithFallback src='forge/potion' alt='potion_card' className='w-[6.25rem] h-[8.125rem] lg:w-[8.5rem] lg:h-[11.12rem] xl:w-[9.5rem] xl:h-[12.12rem]' />
            </div>
            <div className='flex flex-col w-full sm:w-fit items-center text-center justify-center sm:mr-8'>
              <ImageWithFallback src='forge/enchant' alt='enchant_symbol' className='w-[4rem] h-[4rem] lg:w-[6rem] lg:h-[6rem] xl:w-[7rem] xl:h-[7rem] mx-auto sm:mx-[0px] mt-8 sm:mt-[0px]' />
              <span className='text-primary-85 font-bold heading-sm mt-1'>Enchant</span>
            </div>
            <ImageWithFallback src='forge/hector_fusioned' alt='hector_card' className='evolved_dark_blue w-[6.25rem] h-[8.125rem] lg:w-[8.5rem] lg:h-[11.12rem] xl:w-[9.5rem] xl:h-[12.12rem] mx-auto sm:mx-[0px] mt-8 sm:mt-[0px]' />
          </div>
        </div>
      </div>
    </div>
