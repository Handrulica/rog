...
const Tournament = () => {
  ...
  const LineWrapper = ({ src, className }: { src: string, className?: string }) => {
    return <img src={src} className={cn('w-[2rem] h-[3.3rem] pb-3', className)} />
  }

  const Container = ({ className }: { className?: string }) => {
    return (
      <div className={cn("bg-[#910000]/20 border-solid border-[1px] border-primary-30 rounded-[4px] w-[5rem] sm:w-[6rem] h-[1.75rem] self-end", className)} />
    )
  }
      ...
      return (
        <div>
          ...
          <div className='flex justify-center space-x-4 sm:mt-1 gap-[9rem]'>
            <div className='flex justify-center'>
              <LineWrapper src={down_right_medium_second} className='w-[3rem] h-[4.5rem]' />
              <Container className='w-[6rem] mx-1' />
              <LineWrapper src={down_left_medium_second} className='w-[3rem] h-[4.5rem]' />
            </div>
            <div className='flex justify-center'>
              <LineWrapper src={down_right_medium_second} className='w-[3rem] h-[4.5rem]' />
              <Container className='w-[6rem] mx-1' />
          ...
          <div className='flex justify-center'>
            <div className='flex justify-center space-x-2 gap-3'>
              <LineWrapper src={down_right_medium_third} className='w-[6.5rem] h-[5.5rem]' />
              <Container className='sm:w-[7.5rem] self-center mt-8' />
              <LineWrapper src={down_left_medium_third} className='w-[6.5rem] h-[5.5rem]' />
            </div>
          </div>
          <div className='flex justify-center mt-1'>
        ...
        <div>
          <div className='flex items-center'>
            <div className='flex flex-col space-y-16'>
              <div>
                <div className='flex items-center'>
                  ...
                  <LineWrapper src={left_first_down} className='w-[10rem] translate-y-10 -translate-x-2' />
                </div>
                ...
                <div className='flex items-center -translate-y-[1.8rem]'>
                  <Container className='sm:w-[11.25rem] sm:h-[2.8rem] self-center mt-8' />
                  <LineWrapper src={left_first_up} className='w-[10rem] translate-y-2 -translate-x-2' />
                </div>
              </div>
            ...
            <div className='-translate-x-4'>
              <LineWrapper src={left_second_down} className='w-[10rem] h-[8rem] translate-y-2' />
              <Container className='sm:w-[11.25rem] sm:h-[2.8rem] self-center ml-10 ' />
              <LineWrapper src={left_second_up} className='w-[10rem] h-[8rem] translate-y-1' />
            </div>
  ...
  return (
    <div id="tournament_section">
      <h1 className='heading-sm sm:heading-md md:heading-lg xl:heading-2lg xl:heading-3lg font-bold text-center sm:tracking-[0.2rem] text-primary-90 px-8'>the champion’s call tournament</h1>
      ...
      <div className="bg-[url('public/assets/tournament/background.png')] bg-no-repeat bg-center bg-cover">
        <div className='bg-neutrals-0/30'>
          <div className='gradient-two pt-12 px-4'>
            <p className='text-neutrals-100 text-center body-xs sm:text-[14px] xl:text-[20px] px-10 xl:leading-8'>
              Join weekly tournaments of up to 256 players and become Champion of the Realms in less than 1 minute!
              <br />
              Win Colossal Crypto Rewards and Exclusive NFTs as the Revered Legend!
            </p>
            <div className='xl:flex xl:items-center xl:justify-center'>
              ...
              <div className='my-3 flex-shrink-0'>
                <div className='flex flex-col justify-center items-center'>
                  <img src={binance_coin} alt='binance_coin' className='w-10 h-10 sm:w-16 sm:h-16 xl:w-[9.12rem] xl:h-[9.12rem] mb-2' />
                  <span className='text-neutrals-100 font-bold heading-sm xl:heading-2md text-center'>250 BNB</span>
                </div>
                <div className='mt-2 sm:mt-6 rounded-xs bg-[#910000]/20 border-solid border-[1px] border-primary-30 w-fit mx-auto py-1 px-3'>
                  <span className='block text-neutrals-100 font-bold heading-2xxs xl:heading-sm text-center'>Champion of the realms</span>
                </div>
              </div>
          ...
          <div className='gradient-one w-full lg:h-[6rem] xl:h-[10rem]' />
        </div>
      </div>
      <div className='rotate-[180deg] px-4 xl:hidden'>
        <Side />
      </div>
