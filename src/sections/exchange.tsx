        ...
        <div className='bg-neutrals-0/50'>
          <div className="sm:bg-none bg-cover bg-top bg-no-repeat">
            <div className='gradient-two grid sm:grid-cols-2 items-center'>
              <div className='sm:mt-32 sm:pl-10 lg:mt-2 lg:pl-20 lg:pr-10 lg:max-w-2xl'>
                ...
                <p className='heading-2xxs sm:heading-xs md:heading-sm font-bold sm:font-normal text-primary-80 mt-1 text-center sm:text-left sm:mt-2 sm:tracking-wide md:mt-3 px-8 sm:pl-0'>
                  exchange uniques in a flash and dominate the realms of glory treasure hunt!
                </p>
              </div>
            ...
            <div className='pt-48 gradient-three sm:bg-none lg:hidden'>
              ...
              <p className='text-primary font-bold text-center heading-xxs sm:heading-2xxs mt-2 px-8 sm:max-w-2xl sm:px-20 mx-auto'>Unite with Fellow Players to Complete Elusive Sets and Reap Massive Crytpo Rewards!</p>
            </div>
          </div>
          <div className='w-full sm:gradient-three lg:pt-32 lg:flex lg:flex-row-reverse justify-around items-center'>
            <div className='hidden lg:block'>
              ...
              <p className='text-primary font-normal text-center lg:text-left heading-xxs sm:heading-2xxs lg:heading-sm mt-2 px-8 sm:max-w-[45rem] lg:pl-[0px] lg:pr-[7rem] mx-auto tracking-[2px] mt-8'>Unite with Fellow Players to Complete Elusive Sets and Reap Massive Crytpo Rewards!</p>
            </div>
            <div>
      ...
      <div className='grid sm:grid-cols-2 mt-12 sm:mt-20 lg:mt-48 lg:px-24'>
        <div className='px-8'>
          ...
          <p className='text-neutrals-100 body-sm lg:body-lg mt-4 lg:mt-5'>
            The completion of an Elusive Set can sometimes become difficult searching for the missing pieces.
          </p>
          <p className='text-neutrals-100 body-sm lg:body-lg mt-4 lg:mt-5'>
            Hermes gives you the ability to use the <span className='text-blue-70'>TRADE</span>  skill by blindly exchanging any Unique Rarity Card with other players across The Realms.
          </p>
          <p className='text-neutrals-100 body-sm lg:body-lg mt-4 lg:mt-5'>
